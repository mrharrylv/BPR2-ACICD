...
public class Company {
    ...
    public Company(String IC_DPH, String ICO, String NAZOV_DS, String OBEC, String ULICA_CISLO, String PSC, String STAT, String DRUH_REG_DPH, String DATUM_REG, String DATUM_ZMENY_DRUHU_REG) {
        this.IC_DPH = IC_DPH;
        this.ICO = ICO;
